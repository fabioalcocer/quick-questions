...
export function NoteFormSheet({ isOpen, onClose, note, onSuccess }: NoteFormSheetProps) {
    ...
    <Sheet open={isOpen} onOpenChange={handleClose}>
      <SheetContent className="sm:max-w-md">
        <SheetHeader>
          ...
          <SheetDescription>
            {isEditing ? "Update your note and tags below." : "Add a new note with optional tags for organization."}
          </SheetDescription>
        </SheetHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-6 mt-6">
          <div className="space-y-2">
            ...
            />
            <p className="text-xs text-muted-foreground">{text.length}/2000 characters</p>
          </div>
